...
//      @JsonDeserialize(using = CommonStringDeserializer.class)
...
//      @JsonDeserialize(using = CommonStringDeserializer.class)
      ...
      public static RequestDto of(String serviceKey, Integer pageNo, Integer numOfRows, Integer zcode) {
    ...
    public static class ResponseDto {
      ...
      @Schema(description = "응답 Header Dto",
          name = "OpenApiDto.KecoEvChargersInfo.ResponseDto.ResponseHeaderDto"
      )
      @Data
      @Builder
      @NoArgsConstructor
      ...
      @Schema(description = "응답 Body Dto",
          name = "OpenApiDto.KecoEvChargersInfo.ResponseDto.ResponseBodyDto"
      )
      @Data
      @Builder
      @NoArgsConstructor
